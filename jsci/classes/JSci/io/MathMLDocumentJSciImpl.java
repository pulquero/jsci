...
public class MathMLDocumentJSciImpl extends MathMLDocumentImpl {
        ...
        public Element createApply(MathMLExpression expr) {
                ...
                for(int i=0;i<expr.length();i++) {
                        ...
                        else if(arg instanceof AbstractDoubleVector)
                               apply.appendChild(createVector((AbstractDoubleVector)arg));
                        else if(arg instanceof AbstractDoubleMatrix)
                               apply.appendChild(createMatrix((AbstractDoubleMatrix)arg));
                        else
